...
should be. After calling this function, call 'meeting-done' to reset the environment."
  ...
  (use-package org-super-agenda :config (org-super-agenda-mode) :init (setq org-super-agenda-groups
